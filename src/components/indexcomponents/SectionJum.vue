<template>
    <section>
        <b-jumbotron text-variant="white">
            <template v-slot:header><b>欢迎来到 MINECRAFT</b></template>
            <template v-slot:lead>
              新游戏、新更新、新畅玩方式应有尽有，快来加入最大的游戏社区之一，今天就开启创作之旅吧！
            </template>
			<span class="routerborderset">
				<router-link to="/playmethods" class="btn btn-default text-uppercase mt-5">
					<b>获取 minecraft</b>
				</router-link>
			</span>
...
.btn-default {
    ...
    padding: 1.38rem 3.25rem!important;
