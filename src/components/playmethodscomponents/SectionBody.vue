                ...
                <div class="mt-3">
                    <transition name="mytext" mode="out-in">
                        <div key="textindex" v-if="textindex">
                            <div><h2>{{methodsindex}}</h2></div>
                        </div>
                        <div key="texttwo" v-if="texttwo">
                            <div><h2>{{methodstwo}}</h2></div>
                        </div>
                    </transition>
                    ...
                    <transition name="mysectionchild" mode="out-in">
                        <div key="showindex" v-if="showindex">
                            <sectionbodychild @click.native="change(index)" v-for="(value, index) in playmethods" :key=index :data=value></sectionbodychild>
                        </div>
                        <div key="showtwo" v-if="showtwo">
                            <sectionbodychild @click.native="change(index)" v-for="(value, index) in platform" :key=index :data=value></sectionbodychild>
                        </div>
                    </transition>
                </div>
            </div>
                  ...
                  <table class="table col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="background:#f1edec;">
                      <thead>
                        ...
                        <tr style="font-size:12px;color:#36b030">
                            ...
                            <td @click="$emit('work')"><rounter-link to="/playmethods/javaversion" style="font-size:12px;color:#36b030;text-decoration:none;">windows，Mac，Linux(Java 版本)</rounter-link></td>
