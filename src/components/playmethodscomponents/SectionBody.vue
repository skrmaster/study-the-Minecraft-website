                  ...
                  <table class="table col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" style="background:#f1edec;">
                      <thead>
                        ...
                        <tr style="font-size:12px;color:#36b030">
                            ...
                            <td @click="$emit('work')"><router-link to="/playmethods/javaversion" style="font-size:12px;color:#36b030;text-decoration:none;">windows，Mac，Linux(Java 版本)</router-link></td>
